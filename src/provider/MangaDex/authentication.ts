 ...
 */
export const postAuthLogin = (login: PostAuthLoginRequestOptions) => {
  console.warn(
  ...
  if (!("username" in login) && !("email" in login)) {
    return Promise.reject(
 ...
 */
export const getAuthCheck = (token: AuthenticationToken) => {
 ...
 */
export const postAuthLogout = (token: AuthenticationToken) => {
  console.warn(
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const postAuthRefresh = (token: AuthenticationToken) => {
  console.warn(
