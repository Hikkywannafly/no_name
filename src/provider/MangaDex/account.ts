 ...
 */
export const getAccountAvailable = (username: string) => {
  console.warn(
  ...
  if (username === "") {
    return Promise.reject(
      "ERROR - getAccountAvailable: Parameter `username` cannot be blank",
    );
  }
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const getAccountActivateCode = (code: string) => {
  console.warn(
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const postAccountActivateResend = (
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const postAccountRecover = (
 ...
 * Can also resolve to an {@link ErrorResponse} object.
 */
export const postAccountRecoverCode = (
  code: string,
