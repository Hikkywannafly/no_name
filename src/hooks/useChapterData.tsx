...
export default function useChapterData(source: string, mangaId: string, chapterId: string) {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            try {
                ...
                if (!cancelled) setData({ chapters, chapterList, isLoading: false, error: null });
            } catch (error) {
                if (!cancelled) setData({ chapters: [], chapterList: [], isLoading: false, error });
            }
        }
        fetchData();
        return () => {
